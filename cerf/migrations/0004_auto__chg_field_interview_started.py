...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interview.started'
        db.alter_column(u'cerf_interview', 'started', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Interview.started'
        db.alter_column(u'cerf_interview', 'started', self.gf('django.db.models.fields.DateField')(null=True))
