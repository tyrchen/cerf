...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Interview.resume'
        db.delete_column(u'cerf_interview', 'resume')


        # Changing field 'Applicant.resume'
        db.alter_column(u'cerf_applicant', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Interview.resume'
        raise RuntimeError("Cannot reverse this migration. 'Interview.resume' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Applicant.resume'
        raise RuntimeError("Cannot reverse this migration. 'Applicant.resume' and its values cannot be restored.")
