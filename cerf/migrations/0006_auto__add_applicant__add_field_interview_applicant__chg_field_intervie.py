...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cerf_applicant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('resume', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'cerf', ['Applicant'])

        # Adding field 'Interview.applicant'
        db.add_column(u'cerf_interview', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerf.Applicant'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Interview.candidate'
        db.alter_column(u'cerf_interview', 'candidate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'Answer.applicant'
        db.add_column(u'cerf_answer', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerf.Applicant'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Answer.author'
        db.alter_column(u'cerf_answer', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting model 'Applicant'
        db.delete_table(u'cerf_applicant')

        # Deleting field 'Interview.applicant'
        db.delete_column(u'cerf_interview', 'applicant_id')


        # User chose to not deal with backwards NULL issues for 'Interview.candidate'
        raise RuntimeError("Cannot reverse this migration. 'Interview.candidate' and its values cannot be restored.")
        # Deleting field 'Answer.applicant'
        db.delete_column(u'cerf_answer', 'applicant_id')


        # User chose to not deal with backwards NULL issues for 'Answer.author'
        raise RuntimeError("Cannot reverse this migration. 'Answer.author' and its values cannot be restored.")
    ...
    models = {
        ...
        u'cerf.answer': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cerf.Applicant']", 'null': 'True', 'blank': 'True'}),
