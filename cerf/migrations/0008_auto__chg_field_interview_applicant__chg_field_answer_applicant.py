...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interview.applicant'
        db.alter_column(u'cerf_interview', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cerf.Applicant']))

        # Changing field 'Answer.applicant'
        db.alter_column(u'cerf_answer', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cerf.Applicant']))

    def backwards(self, orm):

        # Changing field 'Interview.applicant'
        db.alter_column(u'cerf_interview', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerf.Applicant'], null=True))

        # Changing field 'Answer.applicant'
        db.alter_column(u'cerf_answer', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerf.Applicant'], null=True))
